...
const CertificateCard = ({ title, institution, date, img, link, credentialID, skills }) => {
  ...
  return (
    <motion.div
      className="shadow-2xl rounded-3xl border-2 bg-gradient-to-tl from-gray-100 to-white dark:from-gray-700 dark:to-gray-900 border-gray-300 dark:border-gray-600 h-auto max-h-[500px] p-8 flex flex-col justify-between hover:bg-gradient-to-tl from-gray-100 to-white dark:from-gray-700 dark:to-gray-900 transition-transform transform hover:scale-105"
