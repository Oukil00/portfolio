...
import IIIT_KOTA from "../assets/unifood.png";
  ...
  return (
    ...
    >
      <div className="WRAPPER mt-12">
        <h1 className="text-[#00040f] dark:text-slate-300 font-extrabold text-5xl text-center mb-12">
          EXPERIENCE
        </h1>

        <div
          className="EXPERIENCE grid gap-8 max-sm:gap-6 max-sm:grid-cols-1 grid-cols-2 md:grid-cols-3"
          data-aos="fade-up"
        >
          <Exp_prop
            img={Esc}
